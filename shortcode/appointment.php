...
jQuery(document).on("click", '#step1_next', function (event) {
	...
	if(appointment_service=='default'){
		...
		jQuery('#step1_next').html('<i class="fa fa-spinner fa-spin"></i> Please Wait');
...
function step2_next(){
	...
	if(jQuery('.radio_button').is(':checked')) {
		...
		document.getElementById("stepnext2").href="#step3";
			...
			jQuery('#stepnext2').html('<i class="fa fa-spinner fa-spin"></i> Please Wait');
	...
	<div id="change-loader" class="change-loader" style="display:none">
		<div id="change-loader-inner"></div>
	                   ...
	                   <div id="ap_fornt_main_div" style="display:none;">  
						...
						<?php 	 $appearence_ap_show_logo = $wpdb->get_col( "SELECT ap_show_logo from $appearence_table" );
								...
								<?php
									...
									?>
									<span class="bs_opening_hours"><?php _e("Opening Hours: ",'WL_A_P_SYSTEM' );?><?php _e($biz_start_time,'WL_A_P_SYSTEM' );?><?php _e(" - ".$biz_end_time,'WL_A_P_SYSTEM' ); ?></span><br>
									<?php $appearence_ap_show_phone_no = $wpdb->get_col( "SELECT ap_show_phone_no from $appearence_table" );
									$ap_show_phone_no	= $appearence_ap_show_phone_no[0];
									if($ap_show_phone_no=="yes"){ ?>
									<span class="phone_number_info"><i class="<?php  echo $ap_phone_icon; ?>"></i><?php  echo $ap_phone_no; ?></span>
									<?php } 
								...
								<div class="col-md-3 social-info">
									<ul class="social">
									<?php $appearence_ap_social_link1 = $wpdb->get_col( "SELECT ap_social_link1 from $appearence_table" );
