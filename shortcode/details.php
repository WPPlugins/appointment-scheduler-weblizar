...
function appoint_register(){
	...
	if(appointment_username==''){
	 ...
	 jQuery('#client_email').focus();
		...
		jQuery('#appoint_register').html('<i class="fa fa-spinner fa-spin"></i> Saving');
			jQuery.ajax({
			type : 'post',
            ...
            success : function(data){
				...
				jQuery('#appoint_register').html('Register');
...
function appoint_login(){
	...
	if(appointment_login_email==''){
	 ...
	 jQuery('#ap_password').focus();
		...
		jQuery('#appoint_login').html('<i class="fa fa-spinner fa-spin"></i> Loading');
		...
		jQuery.ajax({
            ...
            success : function(data){
								jQuery("#appoint_login").prop('disabled', true);
								jQuery('#appoint_login').html('<i class="fa fa-spinner fa-spin"></i> Login');
			...
			<div id="new" class="row service-form">
				<form style="margin-bottom: 0;" action="" method="POST" id="ap_register" name="ap_register">
					<div class="col-md-6 col-sm-6 step3-form">
						...
						<input type="text" class="form-control" name="appoint_username" id="appoint_username" placeholder="Enter Usename"/>
					</div>
					<div class="col-md-6 col-sm-6 step3-form">
						<label><?php _e("Email :",'WL_A_P_SYSTEM' ); ?></label>
						<input type="email" class="form-control" name="client_email" id="client_email" placeholder="Enter Email Address"/>
					</div>
					<div class="col-md-6 col-sm-6 step3-form">
					...
					<div class="col-md-6 col-sm-6 step3-form">
						...
						<input type="password" class="form-control" name="client_password" id="client_password" placeholder="Enter Password"/>
					</div>
					<div class="col-md-6 col-sm-6 step3-form">
					...
					<div class="col-md-6 col-sm-6 step3-form">
						...
						<input type="skype_id" class="form-control" name="skype_id" id="skype_id" placeholder="Enter Skype Id"/>
					</div>
					<div class="col-md-6 col-sm-6 step3-form">
						<label><?php _e("Notes :",'WL_A_P_SYSTEM' ); ?></label>
						<input type="notes" class="form-control" name="appoint_notes" id="appoint_notes" placeholder="Enter Notes"/>
					</div>
			...
			<div id="existing" class="row service-form" style="display:none;">
				<form style="margin-bottom: 0;" action="" method="POST" id="ap_login" name="ap_login">
					<div class="col-md-6 col-sm-12 col-xm-12 step3-form">
						<label><?php _e("Email :",'WL_A_P_SYSTEM' ); ?></label>
						<input type="text"  id="ap_email" class="form-control" name="ap_email" placeholder="Enter Email"/>
					</div>
					<div class="col-md-6 col-sm-12 col-xm-12 step3-form">
						<label><?php _e("Password :",'WL_A_P_SYSTEM' ); ?> </label>
						<input type="password" class="form-control" id="ap_password" name="ap_password" placeholder="Enter Password">
					</div>
