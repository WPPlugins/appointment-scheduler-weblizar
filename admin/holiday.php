 ...
 function  holiday_save()
{
	 if(jQuery("#name_update").val()=="")
		...
		jQuery('.save_appt_holiday').html('<i class="fa fa-spinner fa-spin"></i> Creating');  
 ...
 jQuery.ajax({
		...
		success: function (html) {
			...
			jQuery('.save_appt_holiday').html('Create Holiday');
 ...
 function  holiday_update()
{
	if(jQuery("#name_update").val()=="")
		...
		jQuery('.update_appt_holiday').html('<i class="fa fa-spinner fa-spin"></i> Updating');
 jQuery.ajax({
          url: location.href,
          type: "POST",
		...
		success: function (html) {
			...
			jQuery('.update_appt_holiday').html('Update Holiday');
...
jQuery.confirm({
			...
			theme: 'black',
			 content: 'Are you sure to Delete Holiday?',
			animation: 'rotate',
...
jQuery(function(){
 ...
 jQuery.confirm({
	...
	jQuery('.delete_holiday').html('<i class="fa fa-spinner fa-spin"></i> Deleting');			 
 ...
 success:function(res)
 {
	...
	jQuery('.delete_holiday').html('Delete');
													 ...
													 <div class="row ad-ser" id="day_off">
													  ...
													  <div class="row ad-ser p_date_hide">
															  <div class="col-md-12 col-sm-12">
																...
																<input name="event_date" id="event_date" type="text" class="form-control holiday_dates" />
															  </div>
													</div>
														...
														<div class="row ad-ser hide_repeat_day all_hide" style="display:none">
															  <div class="col-md-12 col-sm-12">
																...
																<input name="re_days" id="re_days" type="text"  maxlength="2" class="form-control" />
															  </div>
													   </div>
														 ...
														 <div class="row ad-ser hide_repeat_week all_hide" style="display:none">	  
															  <div class="col-md-12 col-sm-12">
																...
																<input name="re_weeks" id="re_weeks" type="text"  maxlength="2" class="form-control" />
															  </div>
														</div>
														...
														<div class="row ad-ser hide_bi_repeat_week all_hide" style="display:none">
														      <div class="col-md-12 col-sm-12">
																...
																<input name="re_biweeks" id="re_biweeks" type="text"  maxlength="2" class="form-control" />
															  </div>
														</div> 
														    ...
														    <div class="row ad-ser hide_repeat_month all_hide" style="display:none">
																<div class="col-md-12 col-sm-12">
															     ...
															     <input name="re_months" id="re_months" type="text"  maxlength="2" class="form-control" />	
																</div>
															</div>
														 <div class="row ad-ser all_hide p_date_show all_hide" style="display:none">
																  <div class="col-md-6 col-sm-6">
																	<label><?php _e('Start Date','WL_A_P_SYSTEM'); ?></label>
																	<input name="start_date" id="start_date" type="text"  maxlength="2" class="form-control holiday_dates" />
																  </div>
														  
																   <div class="col-md-6 col-sm-6">
																	<label><?php _e('End Date','WL_A_P_SYSTEM'); ?></label>
																	<input name="end_date" id="end_date"  type="text" class="form-control holiday_dates" />
																  </div>
